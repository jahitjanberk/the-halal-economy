...
export const countries = [
  {atlas:'Malaysia',label:'Malaysia',pop:21,giei:165.1,giei2526:186.1,rank:1,verified:['rank','giei2526','fin'],fin:12,bank:20.1,imports:30.6,lon:102,lat:4,region:'asia',oic:true,note:'Top-ranked in halal food, Islamic finance and pharma/cosmetics for the twelfth year. Halal imports grew 12.4% to $30.6B in 2024.'},
  {atlas:'Saudi Arabia',label:'Saudi Arabia',verified:['bank'],pop:34,giei:100.9,rank:2,fin:27,bank:74.9,lon:45,lat:24,region:'mena',oic:true,note:'Largest holder of Islamic finance assets alongside Iran; Islamic banks are roughly three-quarters of domestic banking. Largest OIC halal importer.'},
  {atlas:'Indonesia',label:'Indonesia',verified:['fin'],pop:236,giei:99.9,rank:3,fin:2,bank:5.5,lon:118,lat:-2,region:'asia',oic:true,note:'World\'s largest Muslim population and largest halal food market. #1 in modest fashion. Top destination for Islamic-economy investment (~$1.6B across 40 deals).'},
  {atlas:'United Arab Emirates',label:'United Arab Emirates',verified:['fin','bank'],pop:7,giei:95.8,rank:4,fin:10,bank:22.7,lon:54,lat:24,small:true,region:'mena',oic:true,note:'Moved to #2 in the 2025/26 ranking; top three in every sector and #1 in media & recreation. ~$1.5B in deals across 50 transactions.'},
  {atlas:'Bahrain',label:'Bahrain',verified:['fin','bank'],pop:1.2,giei:81.9,rank:5,fin:3.5,bank:16.1,lon:50.5,lat:26,small:true,region:'mena',oic:true,note:'Long-standing Islamic finance hub and a leading sukuk issuer.'},
  {atlas:'Jordan',label:'Jordan',verified:['bank'],pop:10,giei:71.4,rank:6,fin:null,bank:17.8,lon:36.5,lat:31,region:'mena',oic:true,note:'Islamic banks hold about 18% of domestic banking assets.'},
  {atlas:'Kuwait',label:'Kuwait',verified:['fin','bank'],pop:3.5,giei:67.0,rank:7,fin:5.5,bank:51,lon:47.5,lat:29.4,small:true,region:'mena',oic:true,note:'Islamic banks hold about half of the domestic banking market.'},
  {atlas:'Pakistan',label:'Pakistan',verified:['fin'],pop:231,giei:64.1,rank:8,fin:2,bank:null,lon:69,lat:30,region:'asia',oic:true,note:'Entered the GIEI top ten for the first time in 2024/25.'},
  {atlas:'Turkey',label:'Türkiye',verified:['fin'],pop:81,giei:64.0,rank:9,fin:3.5,bank:null,lon:35,lat:39,region:'mena',oic:true,note:'Among the five largest OIC halal importers and a major exporter into OIC markets; #2 in modest fashion (2024/25).'},
  {atlas:'Qatar',label:'Qatar',verified:['fin','bank'],pop:2,giei:60.4,rank:10,fin:5.5,bank:28.6,lon:51.2,lat:25.3,small:true,region:'mena',oic:true,note:'Islamic banks hold about 29% of domestic banking assets.'},
  ...
  {atlas:'Sudan',label:'Sudan',verified:['bank'],pop:42,bank:100,lon:30,lat:15,region:'mena',oic:true,note:'Banking system is entirely Islamic.'},
  ...
  {atlas:'Oman',label:'Oman',verified:['bank'],pop:4,bank:16.6,lon:57,lat:21,region:'mena',oic:true},
