...
export function drawRankings(){
  ...
  const cols={'Malaysia':'#1F7A63','Saudi Arabia':'#B8912F','Indonesia':'#5FA88F','United Arab Emirates':'#132D28','Bahrain':'#C9A24B'};
  ...
  svg.append('text').attr('x',mL).attr('y',12).attr('font-size',11).attr('fill','#6E837D').text(narrow?'Intermediate editions not shown.':'Gap between 2019/20 and 2023/24: intermediate editions not shown.');
