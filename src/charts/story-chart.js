...
export function buildStoryChart(){
  ...
  svg.append('text').attr('x',narrow?0:mL).attr('y',narrow?12:16).attr('font-size',12).attr('fill',MUTED).text(narrow?'Hajj pilgrims per year, millions':'Hajj pilgrims per year, millions (GASTAT)');
